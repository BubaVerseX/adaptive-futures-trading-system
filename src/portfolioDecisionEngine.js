...
const STRATEGIES = Object.freeze([
  { id: "TREND_BREAKOUT", strategyId: "v15TrendBreakoutWeight", evaluate: evaluateTrendBreakout },
  { id: "MULTI_TIMEFRAME_TREND", strategyId: "v15MultiTimeframeTrendWeight", evaluate: evaluateMultiTimeframeTrend },
  { id: "TREND_PULLBACK", strategyId: "v15TrendPullbackWeight", evaluate: evaluateTrendPullback },
]);

function normalizeWeights(config) {
  const raw = Object.fromEntries(STRATEGIES.map((strategy) => [strategy.id, Math.max(0, numeric(config[strategy.strategyId], 1))]));

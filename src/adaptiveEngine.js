...
class AdaptiveEngine {
  ...
  memoryRecordFromTrade(trade) {
    ...
    return {
      ...
      maximumFavorableExcursionPct: numeric(trade.maximumFavorableExcursionPct),
      maximumAdverseExcursionPct: numeric(trade.maximumAdverseExcursionPct),
      inactivityRelaxedEntry: Boolean(trade.inactivityRelaxedEntry),
      inactivityRecoveryStage: trade.inactivityRecoveryStage || (trade.dynamicInactivityRecovery && trade.dynamicInactivityRecovery.stage) || "NONE",
      inactivityRelaxationSuccessful: Boolean(trade.inactivityRelaxationSuccessful),
      softenedRejections: Array.isArray(trade.softenedRejections) ? trade.softenedRejections : [],
      participationRecoveryMode: Boolean(trade.participationRecoveryMode),
      nearMissTrade: Boolean(trade.nearMissTrade),
      nearMissGap: numeric(trade.nearMissGap),
      nearMissQualityAllowed: Boolean(trade.nearMissQualityAllowed),
      nearMissQualityGap: numeric(trade.nearMissQualityGap),

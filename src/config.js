...
function loadConfig() {
  ...
  const config = {
    ...
    minSignalScore: numberValue("MIN_SIGNAL_SCORE", 46, { positive: true, maximum: 100 }),
    ...
    minVolumeSpike: numberValue("MIN_VOLUME_SPIKE", 1.45, { positive: true }),
    minBurstMomentumPct: numberValue("MIN_BURST_MOMENTUM_PCT", 0.10, { positive: true }),
    ...
    minConvictionScore: numberValue("MIN_CONVICTION_SCORE", 55, { positive: true, maximum: 100 }),
    ...
    explorationTradeRatio: numberValue("EXPLORATION_TRADE_RATIO", 0.35, { minimum: 0, maximum: 0.6 }),
    explorationMinSignalScore: numberValue("EXPLORATION_MIN_SIGNAL_SCORE", 36, { positive: true, maximum: 100 }),
    explorationMinConvictionScore: numberValue("EXPLORATION_MIN_CONVICTION_SCORE", 42, { positive: true, maximum: 100 }),
    explorationMinProjectedEdgePct: numberValue("EXPLORATION_MIN_PROJECTED_EDGE_PCT", 0.22, { minimum: 0 }),
    explorationMinEdgeToCostRatio: numberValue("EXPLORATION_MIN_EDGE_TO_COST_RATIO", 1.25, { positive: true }),
    explorationRiskMultiplier: numberValue("EXPLORATION_RISK_MULTIPLIER", 0.4, { positive: true, maximum: 1 }),
    explorationMaxChopScore: numberValue("EXPLORATION_MAX_CHOP_SCORE", 4, { minimum: 0, maximum: 10 }),
    explorationMaxTradesPerDay: numberValue("EXPLORATION_MAX_TRADES_PER_DAY", 14, { minimum: 0, integer: true }),
    ...
    profitProtectionSignalAdjustment: numberValue("PROFIT_PROTECTION_SIGNAL_ADJUSTMENT", 3, { minimum: 0, maximum: 20 }),

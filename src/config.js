...
function loadConfig() {
  ...
  const config = {
    ...
    forcedSamplingMinScore: numberValue("FORCED_SAMPLING_MIN_SCORE", 20, { positive: true, maximum: 100 }),
    forcedSamplingMinConviction: numberValue("FORCED_SAMPLING_MIN_CONVICTION", 24, { positive: true, maximum: 100 }),
    forcedSamplingMinProjectedEdgePct: numberValue("FORCED_SAMPLING_MIN_PROJECTED_EDGE_PCT", 0.01, { minimum: 0 }),
    ...
    explorationTradeRatio: numberValue("EXPLORATION_TRADE_RATIO", 0.85, { minimum: 0, maximum: 1 }),
    explorationMinSignalScore: numberValue("EXPLORATION_MIN_SIGNAL_SCORE", 20, { positive: true, maximum: 100 }),
    explorationMinConvictionScore: numberValue("EXPLORATION_MIN_CONVICTION_SCORE", 24, { positive: true, maximum: 100 }),
    explorationMinProjectedEdgePct: numberValue("EXPLORATION_MIN_PROJECTED_EDGE_PCT", 0.01, { minimum: 0 }),
    ...
    explorationMaxChopScore: numberValue("EXPLORATION_MAX_CHOP_SCORE", 8, { minimum: 0, maximum: 10 }),

...
const REQUIRED_NON_SECRET_SETTINGS = Object.freeze({
  ...
  INACTIVITY_RECOVERY_4H_CONVICTION_RELAX_POINTS: "2",
  INACTIVITY_RECOVERY_8H_CONVICTION_RELAX_POINTS: "4",
  INACTIVITY_RECOVERY_12H_CONVICTION_RELAX_POINTS: "6",
  V11_ACTIVE_MARKET_ENGINE: "true",
  V11_NEAR_MISS_REEVALUATION_MAX_GAP: "3",
  V11_MEAN_REVERSION_ENABLED: "true",
  V11_MEAN_REVERSION_RANGE_EDGE_PCT: "0.22",
  V11_MEAN_REVERSION_SCORE_BOOST: "10",
  V11_VOLATILE_BREAKOUT_BOOST: "8",
  V11_PANIC_RISK_MULTIPLIER: "0.55",
  V11_HIGHER_TIMEFRAME_ALIGNMENT_BOOST: "7",
  V11_HIGHER_TIMEFRAME_CONFLICT_PENALTY: "9",
  CANDLE_INTERVAL_MACRO_LONG: "240M",
